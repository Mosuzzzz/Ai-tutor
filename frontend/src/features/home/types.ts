...
export type HomeNavigationContent = Record<HomeNavigationKey, string> & { startStudying: string; myWorkspace: string };
...
export type HomeContent = {
  ...
  access: HomeSectionContent & { guestTitle: string; guestBody: string; guestCta: string; memberTitle: string; memberBody: string; memberCta: string };
