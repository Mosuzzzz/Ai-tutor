...
export const AppShell = ({ children, session }: AppShellProps) => {
  ...
  return (
    <div className="min-h-screen overflow-x-clip bg-background text-on-background lg:grid lg:grid-cols-[280px_minmax(0,1fr)]">
      <a
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        ...
        <main
          ...
          className="flex-1 px-4 py-5 outline-none sm:px-6 md:px-8 md:py-8 lg:px-10"
          id="main-content"
          tabIndex={-1}
        >
