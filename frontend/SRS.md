...
AI Tutor Frontend เป็น Next.js 16 App Router application สำหรับแพลตฟอร์มผู้ช่วยเรียนรู้ด้วย AI โดยช่วงปัจจุบันมีฐาน UI, หน้า Auth แบบ mock, หน้า Student Dashboard, Teacher Dashboard, Document Summary และ AI Chat & Summary แบบ mock/API-ready ก่อนเชื่อมต่อ Backend จริง
...
- `npm test`: 29 test files, 91 tests
...
For the current AI Chat & Summary commit, include:
...
This feature replaces the `/chat` placeholder with a mock/API-ready AI Chat & Summary workspace while keeping Backend/Auth integration deferred.
